...
private:
	...
	bool HasDiagonalBeenWon(int topRowStartLocation, bool forward, const char piece) const;
	...
	int CheckSomeoneAboutToWinDiag(int topRowStartLocation, bool forward, const char piece) const;
